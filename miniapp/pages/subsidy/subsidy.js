...
Page({
  ...
  loadData: function(reset) {
    ...
    api.subsidies({ page: this.data.page, size: 20, state: this.data.status }, function(res) {
  ...
  goApply: function() { wx.navigateTo({ url: '/pages/subsidy-apply/subsidy-apply' }) },
  goDetail: function(e) {
    wx.navigateTo({ url: '/pages/subsidy-detail/subsidy-detail?id=' + e.currentTarget.dataset.id })
  }
})
